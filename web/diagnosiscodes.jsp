...
// Set up the SQL statement
    String myQuery     = "select * from diagnosiscodes order by code";
    String url         = "diagnosiscodes_d.jsp";
    String title       = "Diagnosis Codes";
...
//    lst.setTableHeading(title);
    ...
    lst.setOnClickOption("\"Codes\",\"width=450,height=150,scrollbars=no,left=100,top=100,\"");
