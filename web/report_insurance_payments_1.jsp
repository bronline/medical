...
<script>
    ...
    function printReport(fromDate,toDate,showDetail) {
      window.open('print_report_insurance_payments.jsp?reportDate='+fromDate+'&reportToDate='+toDate+'&showDetail='+showDetail,'print','height=300,width=790,menubar=yes,scrollbars=yes,resizable');
    }
...
<%
  ...
  String dateToPicker = "<image src=\"images/show-calendar.gif\" " +
   ...
   out.print(htmTb.addCell("<b>Show Detail</b>","width=75"));
   out.print(htmTb.addCell(frm.checkBox(showDetail, "showDetail"), "width=100"));
   ...
   myQuery += "group by providers.id, `date`, checknumber order by `date`";
   ...
   out.print("<br><br><input type=button class=button value='print' onClick=printReport('" + Format.formatDate(reportDate, "yyyy-MM-dd") + "','" + Format.formatDate(reportToDate, "yyyy-MM-dd") + "'," +showDetail + ")>&nbsp;&nbsp;&nbsp;<input type=button class=button value='send to Excel' onClick=sendToExcel()>");
