...
// Set up the SQL statement
    String myQuery     = "select * from documenttypes order by description";
    String url         = "documenttypes_d.jsp";
...
//    lst.setTableHeading(title);
    ...
    lst.setOnClickOption("\"types\",\"width=450,height=150,scrollbars=no,left=100,top=100,\"");
