...
// Create a new paymentform
    ...
    iForm.append(htmTb.startTable("800"));
    iForm.append(htmTb.startRow());
    iForm.append(htmTb.headingCell("Date", "width=50"));
    iForm.append(htmTb.headingCell("Description", "width=225"));
    iForm.append(htmTb.headingCell("Charge<br>Amount", htmTb.RIGHT, "width=50"));
    iForm.append(htmTb.headingCell("Recvd<br>Amount", htmTb.RIGHT, "width=50"));
    iForm.append(htmTb.headingCell("Balance", htmTb.RIGHT, "width=50"));
    iForm.append(htmTb.headingCell("Copay", "width=50"));
//    iForm.append(htmTb.headingCell("Check Number", "width=80"));
    iForm.append(htmTb.headingCell("Pmt<br> Amt", "width=75"));
    iForm.append(htmTb.headingCell("Write<br>Off", "width=75"));
    ...
    String chargeId="0";
    iForm.append("<div style=\" height: 300; width: 820; overflow: auto;\">");
    iForm.append(htmTb.startTable("800"));
...
//        String copay = ""+bDCopay;
        ...
        iForm.append(htmTb.addCell(pRs.getString("description"), "width=225"));
//        iForm.append(htmTb.addCell(copayAmount, 1, "width=50"));
        iForm.append(htmTb.addCell(Format.formatCurrency(pRs.getString("chargeamount")), htmTb.RIGHT, "width=50"));
        iForm.append(htmTb.addCell(Format.formatCurrency(pRs.getString("paidamount")), htmTb.RIGHT, "width=50"));
        iForm.append(htmTb.addCell(Format.formatCurrency(pRs.getString("balance")), htmTb.RIGHT, "valign=middle width=50 id=bal"+chargeId));
        ...
        iForm.append(htmTb.addCell(frm.textBox(tools.utils.Format.formatCurrency(woAmount), "woAmount"+chargeId, "10","10","style='text-align: right;' class=tBoxText onBlur=\"this.value=formatCurrency(this.value);calcPatAmt(this)\""), htmTb.RIGHT, "width=75"));
