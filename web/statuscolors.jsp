...
// Set up the SQL statement
    String myQuery     = "select * from statuscolors order by id";
    String url         = "statuscolors_d.jsp";
    String title       = "Colors";
...
//    lst.setTableHeading(title);
    ...
    lst.setOnClickOption("\"" + title + "\",\"width=450,height=300,scrollbars=no,left=100,top=100,\"");
...
// Show the filtered list
    ...
    out.print(fldSet.getFieldSet(lst.getHtml(myQuery), "style='width: " + lst.getTableWidth() +"'", "Status Colors", "style='font-size: 12; font-weight: bold;' align=center"));
