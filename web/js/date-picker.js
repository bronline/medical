...
Calendar.prototype.show = function() {
	...
	this.wwrite("<TABLE WIDTH='103%' BORDER=1 CELLSPACING=0 CELLPADDING=0 BGCOLOR='#e0e0e0'><TR><TD ALIGN=center><font SIZE=1>");
	this.wwrite("[<A HREF=\"" +
...
function show_calendar() {
	...
	*/
	...
	vWinCal = window.open("", "Calendar", 
		"width=190,height=170,status=no,resizable=no,top=200,left=200");
	vWinCal.opener = self;
	ggWinCal = vWinCal;
