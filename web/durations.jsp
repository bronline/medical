...
// Set up the SQL statement
    String myQuery     = "select * from durations order by intervals";
    String url         = "durations_d.jsp?";
    String title       = "Durations";

// Create an RWFiltered List object
    RWFilteredList lst = new RWFilteredList(io);
    RWHtmlTable htmTb  = new RWHtmlTable("320", "0");
...
// Show the filtered list
    ...
    out.print(fldSet.getFieldSet(lst.getHtml(myQuery), "style='width: " + lst.getTableWidth() +"'", "Durations", "style='font-size: 12; font-weight: bold;' align=center"));
