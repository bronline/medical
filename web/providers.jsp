...
// Set up the SQL statement
    String myQuery     = "select id, name, phonenumber, extension, contactname, contactemail from providers order by reserved desc, name";
...
// Show the filtered list
    ...
    out.print(fldSet.getFieldSet(lst.getHtml(myQuery), "style='width: " + lst.getTableWidth() +"'", "Providers", "style='font-size: 12; font-weight: bold;' align=center"));

    out.print(frm.startForm());
    out.print(frm.button("New " + title, "class=button onClick=window.open(\"" + url + "?id=0\",\"Locations\",\"width=450,height=350,scrollbars=no,left=100,top=100,\");" ));
