...
<script language="javascript">
    ...
    function deletePayment(id) {
        var url='ajax/deleteedipayment.jsp?id='+id;
    ...
    function showBatchdetails(what,id) {
        alert("Batch detail listing is not available yet.");
    }
</script>
...
// Initialize the work variables
    ...
    // Set special attributes on the filtered list object
        String [] cw       = {"0", "200", "100", "200"};
        String [] ch       = {"", "EOB Batch Name", "Date<br/>Processed", "Status" };
        
        String batchQuery = "select id, batchname, dateprocessed, replace(`status`,'\n','<br/>') as `status` from eobbatches order by dateprocessed desc";
        ...
        lst.setOnClickAction(1, "onClick=showBatchdetails(this,##idColumn##) style=\"cursor: pointer; color: #2c57a7; font-weight: bold;\"");
    ...
    // Show the submit button
        uf.append(frm.submitButton("  process file  ", "class=button", "saveBtn"));
...
//        out.print(myQuery);
        ...
        out.print("<script type=\"text/javascript\">alert('Your file has been processed'); location.href=\"uploadedi835.jsp\";</script>");

    }
    session.setAttribute("parentLocation", "uploadedi835.jsp");
%>
