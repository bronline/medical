...
// Set up the SQL statement
    String myQuery     = "select documentidentifiers.id, documenttypes.description, " +
                         "documentidentifiers.sequence, documentidentifiers.identifier, " +
                         "documentidentifiers.multiplesallowed " +
                         "from documentidentifiers " +
                         "join documenttypes on documenttypes.id=documentidentifiers.documenttype " +
                         "order by documenttypes.description, documentidentifiers.sequence";
    String url         = "documentidentifiers_d.jsp";
    String title       = "Document Identifiers";
...
//    lst.setTableHeading(title);
    ...
    lst.setOnClickOption("\"Identifiers\",\"width=450,height=150,scrollbars=no,left=100,top=100,\"");
...
// Show the filtered list
    ...
    out.print(fldSet.getFieldSet(lst.getHtml(myQuery), "style='width: " + lst.getTableWidth() +"'", title, "style='font-size: 12; font-weight: bold;' align=center"));
