...
<script type="text/javascript">
    ...
    function printAgingReport(providerId,pType) {
        window.open("print_aging.jsp?printReport=Y&providerId=" + providerId + "&patientType=" + pType,"AgingReport");
    }
...
String myQuery="select patients.id as patientid, patients.accountnumber, concat(patients.firstname, ' ', patients.lastname) as patientname, DATEDIFF(current_date,visits.date) as daysold, " +
        "visits.`date` as dateofservice, items.code, case when patients.ssn=0 then '' else patients.ssn end as ssn, patients.dob, " +
        ...
        " and DATEDIFF(current_date,visits.`date`)>=" + delinquentDays;
...
//if (request.getMethod().equals("POST")) {
    ...
    myQuery += " order by CONCAT(patients.lastname, patients.firstname)";
