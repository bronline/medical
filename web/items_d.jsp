...
// Initialize local variables
    String myQuery          = "select id, typeid, description, amount, code, modifier, buttoncolor, buttontextcolor, buttontext, " +
                              "comment, sequence, showitem, writecomment from items ";
