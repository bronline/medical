...
// Show the filtered list
    ...
    out.print(fldSet.getFieldSet(lst.getHtml(myQuery), "style='width: " + lst.getTableWidth() +"'", "Plan Types", "style='font-size: 12; font-weight: bold;' align=center"));
